...
const InventoryPageFixed = ({ properties = [], onSelect, onEdit }) => {
  ...
  return (
    <View className="flex-1 bg-gray-50">
      ...
      {/* --- HEADER & FILTERS --- */}
      <View className="bg-white pt-14 px-5 border-b border-gray-100 shadow-sm">
        ...
        {filteredProperties.length > 0 ? (
           <View className="gap-5">
              {filteredProperties.map(p => (
                 ...
                 >
                    {/* Image Section - Simplified without LinearGradient */}
